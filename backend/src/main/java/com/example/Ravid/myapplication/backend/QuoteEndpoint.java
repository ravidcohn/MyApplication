...
/**
 * Created by Ravid on 20/09/2015.
 */
...
import static com.example.Ravid.myapplication.backend.OfyService.ofy;

@Api(name = "quoteEndpoint", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.myapplication.Ravid.example.com", ownerName = "backend.myapplication.Ravid.example.com", packagePath=""))
